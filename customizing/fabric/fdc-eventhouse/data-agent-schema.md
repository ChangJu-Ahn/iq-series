...
단위까지 갈리는 경우가 있어 특히 위험합니다.

| 센서 | Etcher | CVD |
|---|---|---|
| `CHAMBER_PRESSURE` | 45 **mTorr** (정상 42~48) | 5.0 **Torr** (정상 4.6~5.4) |

1000배 차이입니다. 조인을 틀리면 CVD의 정상값 5.0이 Etcher 한계 42~48에 걸려
**심각한 저압 경보처럼 보입니다.** 온도처럼 자릿수가 비슷한 경우와 달리 값 자체가
그럴듯해서 의심하기 어렵습니다. 한계치를 인용하기 전에 `unit` 을 함께 읽으세요.
