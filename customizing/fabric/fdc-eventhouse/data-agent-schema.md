...
주변 온·습도 2종만 5분 간격입니다. 기본 픽스처의 65시간 구간이 약 102,000행이고,
...
정상이 98.5% 정도이고 경보는 0.25% 안팎입니다. 경보는 **가동 중에만** 나며 유휴
구간에는 0건입니다. 경보가 여러 설비에 고르게 퍼져 있으면 데이터가 잘못된 것입니다.
불량률이 높은 설비에 몰려 있는 것이 정상입니다.
